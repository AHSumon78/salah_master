...
class NativeAlarmReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (action == "com.butterflydevs.salahmaster.UPDATE_WIDGET" || action == Intent.ACTION_BOOT_COMPLETED) {
            // সমস্ত লজিকের কাজ করার জন্য সার্ভিসকে কল করা হলো
...
class WidgetUpdateService : JobIntentService() {
    ...
    companion object {
        private const val JOB_ID = 8802 // যেকোনো একটি ইউনিক আইডি

        // এই মেথডটি দিয়ে রিসিভার থেকে সার্ভিস শুরু করা হবে
    ...
    override fun onHandleWork(intent: Intent) {
        Log.d("WidgetUpdateService", "Started background work execution.")
        ...
        // 👑 ট্রিকি পার্ট: ভাষা চেকের আগেই এপিআই-এর ডটওয়ালা নামকে একদম ক্লিন করে নেওয়া হলো
        val cleanMonthNameEn = rawMonthNameEn
            .replace("ū", "u")
            .replace("ī", "i")
            .replace("Ḥ", "H")
        ...
        // 🗓️ ডارت সাইডের মতো হুবহু ২ লাইনের সুন্দর উইজেট টেক্সট জেনারেশন
        val formattedHijri = if (isBn) {
            val hijriMonthsBn = mapOf(
                "Muharram" to "মুহাররম", "Safar" to "সফর", "Rabi' al-awwal" to "রবিউল আউয়াল",
                "Rabi' ath-thani" to "রবিউস সানি", "Jumada al-ula" to "জুমাদাল উলা", "Jumada al-akhirah" to "জুমাদাল আখিরা",
        ...
        Log.d("WidgetUpdateService", "Finished processing. Next alarm at: $nextTargetTime")
    }
}